...
$classes = ($active ?? false)
            ? 'p-2 flex justify-between items-end leading-none gap-1 border-r-2 border-white text-sm font-medium focus:outline-none focus:border-white transition duration-150 ease-in-out'
